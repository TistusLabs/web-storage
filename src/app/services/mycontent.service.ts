...
export class MyContentService {
    ...
    private _url_getitems = "http://23.96.7.8/filemanagement/filemanager/filemanager/getitems";
    private _url_createfolder = "http://23.96.7.8/filemanagement/filemanager/filemanager/createfolder";
    private _url_uploadfile = "http://23.96.7.8/filemanagement/filemanager/filemanager/uploadfile";
    private _url_getfile = "http://23.96.7.8/filemanagement/filemanager/filemanager/showfile";
    private _url_getfilenew = "http://23.96.7.8/filemanagement/filemanager/filemanager/getFile";
    private _url_sharefile = "http://23.96.7.8/filemanagement/filemanager/filemanager/sharefile";
    private _url_sharefolder = "http://23.96.7.8/filemanagement/filemanager/filemanager/shareFolders";
    private _url_searchfile = "http://23.96.7.8/filemanagement/filemanager/filemanager/searchByName";
    private _url_updatefile = "http://23.96.7.8/filemanagement/filemanager/filemanager/updateFileName";
    private _url_updateFolder = "http://23.96.7.8/filemanagement/filemanager/filemanager/updateFolderName";
    private _url_deletefile = "http://23.96.7.8/filemanagement/filemanager/filemanager/deleteFile";
    private _url_deletefolder = "http://23.96.7.8/filemanagement/filemanager/filemanager/deleteFolder";
    private _url_starfile = "http://23.96.7.8/filemanagement/filemanager/filemanager/starred";
    private _url_unstarfile = "http://23.96.7.8/filemanagement/filemanager/filemanager/unstarred";
    private _url_downloadcontent = "http://23.96.7.8/filemanagement/filemanager/filemanager/multiDownload";
    private _url_deleteditems = "http://23.96.7.8/filemanagement/filemanager/Admin/getdeletedItems";
    private _url_permanentDelete = "http://23.96.7.8/filemanagement/filemanager/Admin/deleteItems";
    private _url_sharebyemail = "http://23.96.7.8/filemanagement/filemanager/filemanager/sendByEmail";
