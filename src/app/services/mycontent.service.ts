...
export class MyContentService {
    ...
    private _url_getitems = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/getitems";
    private _url_createfolder = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/createfolder";
    private _url_uploadfile = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/uploadfile";
    private _url_getfile = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/showfile";
    private _url_getfilenew = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/getFile";
    private _url_sharefile = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/sharefile";
    private _url_sharefolder = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/shareFolders";
    private _url_searchfile = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/searchByName";
    private _url_updatefile = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/updateFileName";
    private _url_updateFolder = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/updateFolderName";
    private _url_deletefile = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/deleteFile";
    private _url_deletefolder = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/deleteFolder";
    private _url_starfile = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/starred";
    private _url_unstarfile = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/unstarred";
    private _url_downloadcontent = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/multiDownload";
    private _url_deleteditems = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/Admin/getdeletedItems";
    private _url_permanentDelete = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/Admin/deleteItems";
    private _url_sharebyemail = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/sendByEmail";
    private _url_unshare_file = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/unSharefile";
    private _url_unshare_folder = "http://dmsuat.eastasia.cloudapp.azure.com/filemanagement/filemanager/filemanager/unSharefolders";
    ...
    public getSharedFolderItems(folderID: string, userId: string): Observable<HttpEvent<IFilemanager>> {
        this.requestParams = new HttpParams()
            .set('userId', userId)
            .set('folder', folderID);
